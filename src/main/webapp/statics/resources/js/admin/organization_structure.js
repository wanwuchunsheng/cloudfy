...
jQuery(document).ready(function() {
	...
	$('#updatePosition').click(function(){
		...
		createAjax.modal("show");
		createAjax.load(contextPath + "/admin/department/position/viewUpdate.json?id=" + ids[0], function() {
...
function addOrDeletePerson(deptId, id) {
	location.href = contextPath + "/admin/user/users/list.htm?deptId="+ deptId+"&id="+id;
}
